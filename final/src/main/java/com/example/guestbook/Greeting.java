...
public final class Greeting {
	 ...
	 **/
	public Greeting(final String book, final String content) {
		this();
		if (book != null) {
			this.theBook = Key.create(Guestbook.class, book); // Creating the
																// Ancestor key
		} else {
	 ...
	 **/
	public Greeting(final String book, final String content, final String id, final String email) {
		this(book, content);
